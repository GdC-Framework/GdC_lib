/*
    ...
    copyToClipboard format["static_unit_x = [SOLDAT, [%1, %2, %3], %4, UNIT_SIDE] call LUCY_fnc_spawnStaticInf;", (getPosASL  player select 0), getPosASL player select 1, getPosASL player select 2, getDir player];
...
_unit_spawn = createGroup _unit_side createUnit[_unit_type, getMarkerPos LUCY_IA_MARKER_SPAWN_STATIC_UNIT_NAME, [], 0, "NONE"];
...
[_unit_spawn, _unit_side, _unit_skill] call GDC_fnc_lucyAISetConfig;
