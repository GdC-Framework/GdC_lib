...
while {true} do
{
			...
			then
				{
							...
							switch(true)do
							{
											...
											case (
																...
																and
																!([getPosATL(leader _x),GAIA_CACHE_STAGE_1] call GDC_gaia_fnc_isNearPlayer)
																and
										 ...
										 //We are cached, player is in range 1
					  					...
					  					case (
 											...
 											default {_x spawn GDC_gaia_fnc_syncCachedGroup;};
							};


							//Cache stage 2
							if (
											!([getPosATL(leader _x),GAIA_CACHE_STAGE_2] call GDC_gaia_fnc_isNearPlayer)
											//and
											//(behaviour(leader _x)!="COMBAT")
											/*
											and
					   	...
					   	then 	{[_x] call GDC_gaia_fnc_cacheFar;};
	 ...
	 _idx = 0;
	 {
	 						...
	 						if ([_x,GAIA_CACHE_STAGE_2] call GDC_gaia_fnc_isNearPlayer)
	 						then
	 						{
	 							[(missionNamespace getVariable [ "GAIA_CACHE_" + str(_x),[0,0,0]])] call GDC_gaia_fnc_uncacheFar;
