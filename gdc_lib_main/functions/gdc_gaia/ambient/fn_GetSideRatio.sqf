...
_distW = [west,_pos,true] call GDC_gaia_fnc_getDistanceToClosestZone;
_distE = [east,_pos,true] call GDC_gaia_fnc_getDistanceToClosestZone;
_distI = [independent,_pos,true] call GDC_gaia_fnc_getDistanceToClosestZone;
